def deploy_contract(plan, network, endpoint_address):
    ...
    plan.print("ULN302 Send Library address for network %s: %s" % (network.name, send_lib_address))
